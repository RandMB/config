...
cp $CONFIG_DIR/ranger/rc.conf 		$GIT_DIR/.config/ranger/
cp $CONFIG_DIR/ranger/rifle.conf 	$GIT_DIR/.config/ranger/
cp $CONFIG_DIR/ranger/scope.sh 		$GIT_DIR/.config/ranger/
cp $CONFIG_DIR/ranger/bookmarks 	$GIT_DIR/.config/ranger/
